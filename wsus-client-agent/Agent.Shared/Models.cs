...
/// <summary>
/// One row from the permanent `history` table - what "Installation
/// Status" displays, since `updates` only ever reflects the current
/// pending list and drops a row the moment it's no longer offered
/// (i.e. right after a successful install).
/// </summary>
public class HistoryEntry
{
    public string? KbArticle { get; set; }
    public string Title { get; set; } = "";
    public string Status { get; set; } = "";   // "Installed" | "Failed"
